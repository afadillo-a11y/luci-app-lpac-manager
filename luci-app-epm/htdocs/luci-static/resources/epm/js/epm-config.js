...
Developed by: Giammarco M. <stich86@gmail.com> - Edited by Medvedolog
Version: 2.3.0
*/
...
function populateForm(config) {
    if (config.epm) {
        // Global settings
        document.getElementById('apdu_backend').value = config.epm.apdu_backend || 'qmi';
        ...
        // Reboot settings
        document.getElementById('reboot_method').value = config.epm.reboot_method || 'qmi';
        document.getElementById('reboot_at_command').value = config.epm.reboot_at_command || 'AT+CFUN=1,1';
        document.getElementById('reboot_at_device').value = config.epm.reboot_at_device || '/dev/ttyUSB3';
        document.getElementById('reboot_qmi_device').value = config.epm.reboot_qmi_device || '/dev/cdc-wdm0';
        document.getElementById('reboot_qmi_slot').value = config.epm.reboot_qmi_slot || config.epm.qmi_sim_slot || '1';
        document.getElementById('reboot_mbim_device').value = config.epm.reboot_mbim_device || '/dev/cdc-wdm0';
...
function setDefaultValues() {
    ...
    document.getElementById('apdu_backend').value = 'qmi';
    ...
    document.getElementById('reboot_method').value = 'qmi';
